  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-blue-700 text-slate-50 hover:bg-slate-900 hover:text-slate-50 focus:bg-blue-900 focus:text-slate-50 ",
        day_today: "bg-blue-300 text-blue-600 dark:bg-slate-800 dark:text-slate-50",
        day_outside:
